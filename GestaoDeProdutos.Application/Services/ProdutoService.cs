...
namespace GestaoDeProdutos.Application.Services
{
    public class ProdutoService : IProdutoService
    {
        ...
        public async Task AtualizarEstoque(Guid id, int quantidade)
        {
            ...
            int quantidadeEstoque = buscaProduto.Quantidade_Estoque;
        ...
        private void EnviarEmailEstoqueBaixo(Produto produto)
        {
            ...
            string corpoEmailModelo = $"Olá Comprador(a), o produto {produto.Nome} está abaixo do estoque mínimo {produto.Estoque_Minimo} " +
